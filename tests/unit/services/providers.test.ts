...
describe('providers service', () => {
  ...
  it('getAllProviders delegates to electronAPI', async () => {
    const mock = stubElectronAPI()
    const { getAllProviders } = await import('../../../src/services/providers.ts')
  ...
  it('getProviderById delegates with correct id', async () => {
    const mock = stubElectronAPI()
    const { getProviderById } = await import('../../../src/services/providers.ts')
  ...
  it('createProvider delegates with provider data', async () => {
    const mock = stubElectronAPI()
    const { createProvider } = await import('../../../src/services/providers.ts')
  ...
  it('updateProvider delegates with id and data', async () => {
    const mock = stubElectronAPI()
    const { updateProvider } = await import('../../../src/services/providers.ts')
  ...
  it('deleteProvider delegates with the id', async () => {
    const mock = stubElectronAPI()
    const { deleteProvider } = await import('../../../src/services/providers.ts')
