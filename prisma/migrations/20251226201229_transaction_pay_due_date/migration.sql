/*
  ...
  - Added the required column `payDueDate` to the `Purchase` table without a default value. This is not possible if the table is not empty.
  - Added the required column `payDueDate` to the `Sale` table without a default value. This is not possible if the table is not empty.
